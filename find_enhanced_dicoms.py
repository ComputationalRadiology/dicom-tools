...
parser = argparse.ArgumentParser(description='Find enhanced DICOM files.')
...
for dicom_loc in unsortedList:
    ...
    SOPClassUID = ds.get("SOPClassUID","NA")
    # print('SOPClassUID - traditional ' + '1.2.840.10008.5.1.4.1.1.4' )
    # print('SOPClassUID - Enhanced ' + '1.2.840.10008.5.1.4.1.1.4.1'  )
    # NumberOfFrames = ds.get("NumberOfFrames","NA")
    # print('Number Of Frames for ' + dicom_loc + ' '  + str(NumberOfFrames) )
    if str(SOPClassUID) != '1.2.840.10008.5.1.4.1.1.4.1':
      continue;
...
if not count == fileCount:
  logging.warning('Number of files in and files out differ.')
