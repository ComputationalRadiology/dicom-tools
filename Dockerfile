...
RUN mkdir /src && cd /src && \
    ...
    cd dcm2niix && mkdir build && cd build && cmake -DUSE_OPENJPEG=ON .. && make && make install
#    cd dcm2niix && mkdir build && cd build && cmake -DBATCH_VERSION=ON -DUSE_OPENJPEG=ON .. && make && make install
